...
namespace AlgorithmPrograms
{
    class PrimeNumbers
    {
        ...
        public static void PrimePalimdrome()
        {
            Console.WriteLine("enter the number to find the prime numbers upto that");
            int n = Utility.IntInput();
